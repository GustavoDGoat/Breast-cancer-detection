# this is the model.py code base
...
def download_model():
    ...
    conv_base = DenseNet201(
        input_shape=(224, 224, 3), include_top=False, pooling="max", weights="imagenet"
    )
    model.add(
        conv_base
    )  # Add the DenseNet201 base as the convolutional feature extractor
